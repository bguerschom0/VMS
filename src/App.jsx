...
return (
    <Routes>
      ...
      {/* Check-in routes */}
      <Route path="/check-in" element={<ProtectedRoute><AuthenticatedLayout><SearchVisitor /></AuthenticatedLayout></ProtectedRoute>} />
      <Route path="/check-in/form" element={<ProtectedRoute><AuthenticatedLayout><VisitorForm /></AuthenticatedLayout></ProtectedRoute>} />

      {/* Check-out routes */}
      <Route path="/check-out" element={<ProtectedRoute><AuthenticatedLayout><CheckOut /></AuthenticatedLayout></ProtectedRoute>} />
      <Route path="/check-out/form" element={<ProtectedRoute><AuthenticatedLayout><CheckoutModal /></AuthenticatedLayout></ProtectedRoute>} />

      {/* Visitor history routes */}
      <Route path="/visitor-history" element={<ProtectedRoute><AuthenticatedLayout><VisitorHistory /></AuthenticatedLayout></ProtectedRoute>} />
      <Route path="/visitor-history/form" element={<ProtectedRoute><AuthenticatedLayout><VisitorDetailsModal /></AuthenticatedLayout></ProtectedRoute>} />

      {/* Bulk visitors route */}
      <Route path="/bulkvisitors" element={<ProtectedRoute><AuthenticatedLayout><BulkVisitorUpload /></AuthenticatedLayout></ProtectedRoute>} />

      {/* Scheduled visitors route */}
      <Route path="/scheduled-visitors" element={<ProtectedRoute><AuthenticatedLayout><ActiveScheduledVisitors /></AuthenticatedLayout></ProtectedRoute>} />

      {/* User Management route */}
      <Route path="/user-management" element={<ProtectedRoute><AuthenticatedLayout><UserManagement /></AuthenticatedLayout></ProtectedRoute>} />

      {/* Reports routes */}
      <Route path="/GuardShiftReport" element={<ProtectedRoute><AuthenticatedLayout><GuardShiftReport /></AuthenticatedLayout></ProtectedRoute>} />
      <Route path="/reports" element={<ProtectedRoute><AuthenticatedLayout><CheckInOutReport /></AuthenticatedLayout></ProtectedRoute>} />
      <Route path="/GuardShiftReportViewer" element={<ProtectedRoute><AuthenticatedLayout><GuardShiftReportViewer /></AuthenticatedLayout></ProtectedRoute>} />
      <Route path="/scheduled-report" element={<ProtectedRoute><AuthenticatedLayout><ScheduledVisitorsReport /></AuthenticatedLayout></ProtectedRoute>} />

      {/* Audit routes */}
      <Route path="/route-documentation" element={<ProtectedRoute><AuthenticatedLayout><RouteDocumentation /></AuthenticatedLayout></ProtectedRoute>} />
      <Route path="/component-documentation" element={<ProtectedRoute><AuthenticatedLayout><ComponentDocumentation /></AuthenticatedLayout></ProtectedRoute>} />
